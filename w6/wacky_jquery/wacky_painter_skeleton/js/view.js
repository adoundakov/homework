...
View.prototype.exercise0 = function () {
  ...
  //Result: this should cause the grid to turn into a long list of
  //undecorated lis just a list of dots
...
View.prototype.exercise6 = function () {
  ...
  for (var i = 0; i < $listItems.length; i++) {
    $($listItems[i]).attr('style', "background-color: " + window._randomColorString());
  }
};
